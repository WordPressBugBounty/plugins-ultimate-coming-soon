...
<body>
  ...
  <div class="ucsm-container"
    style=" background-color: <?php echo wp_kses_post($wpucs_background_color); ?>;  background-image: url('<?php echo esc_url($wpucs_background_image); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat; min-height: 100vh;">
    <!-- Header Top Bar -->
      ...
      <div class="ucsm-bottom-box" style="display:flex; align-items: flex-end;">
        ...
        <div class="ucsm-bottom-content">
          ...
          <h1 class="ucsm-heading" style="order:<?php echo wp_kses_post($wpucs_order_heading); ?>; color: #fff ;font-family: 'urbanist-extrabold';">
            ...
            <span style="order:<?php echo wp_kses_post($wpucs_order_subheading); ?>; color: #ffffff; font-family: 'urbanist-extrabold';"><?php echo wp_kses_post($wpucs_sub_heading); ?></span>
          </h1>
          <!--End Heading Text -->
          <!-- Description Text -->
